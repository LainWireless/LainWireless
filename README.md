...
- **GNU/Linux:** Debian, Ubuntu, CentOS, RockyLinux, RHEL, openSUSE
- **Kernel Compilation and Modules**

### Virtualization
- **Hypervisors Level 1:** KVM, VMware vSphere/ESXi, PROXMOX
- **Hypervisors Level 2:** VirtualBox
- **Containers:** LXC, LXD, Docker, Podman
...
### Databases
- **Database Management Systems:** Oracle, MySQL, MariaDB, PostgreSQL, MongoDB
- **Database Languages:** PL/SQL, PL/PgSQL
...
### Web Application Infrastructure and Development
- **Web Servers & Load Balancers:** Apache, Nginx, IIS, Tomcat, HA-Proxy
- **Web Frameworks:** Django, Flask, Gunicorn, uWSGI
- **Web Development:** HTML, CSS
- **Network File Services:** Samba, NFS
- **DNS and DHCP Services:** Bind9, DNSMasq, Microsoft DNS and DHCP
- **High Availability Services:** Pacemaker and Corosync
...
- **Security Tools:** Snort, Nessus, TripWire, RKHunter, Hydra, Medusa, SFC, John the Ripper

### Networking
- **Network Administration:** Maintenance, Security, OpenVPN, WireWard, VLAN, WiFi, IPv6
- **Cisco Router Administration:** Configuration and management of routers, IOS
